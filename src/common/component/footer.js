    ...
    <footer>
      <div className='footer-nav'>
        <p className='miaov-contact clear'>
          <a className='iconfont icon-youxiang' href='mailto:hr_recruit@miaov.com'>hr_recruit@miaov.com</a>
          <a className='iconfont icon-dianhua' href='tel:010-57269690'>010-57269690</a>
        </p>
        <nav className='clear'>
